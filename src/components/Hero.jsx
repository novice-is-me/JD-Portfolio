    ...
    <Container className="p-5 p-md-0 flex flex-column gap-y-5 justify-evenly flex-md-row mb-6">
      <div className='flex flex-col justify-center order-2 order-md-1 items-center align-items-md-start'>
        <div className=' text-center text-md-start'>
          ...
          <p className=' font-Poppins text-[20px] md:text-[30px] font-medium'>I am a <span className=' text-blue'>Virtual Assistant</span></p>
        </div>
        <div className=' mt-3'>
          <button className=' bg-blue px-10 py-2 text-white font-Poppins rounded-[5rem] text-[20px]'>Hire Me</button>
        </div>
      </div>
